...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2025 at 04:06 AM
...
INSERT INTO `products` (`id`, `title`, `short_des`, `price`, `discount`, `discount_price`, `image`, `stack`, `star`, `remark`, `category_id`, `brand_id`, `created_at`, `updated_at`) VALUES
(1, 'Smartphone', 'Latest smartphone with advanced features', '902.99', 10, '899.99', 'smartphone.jpg', 50, 4.5, '', 1, 1, '2024-12-01 13:29:08', '2025-01-12 03:35:49'),
